...
export default function Footer() {
  ...
  return (
    <footer className="bg-agri-dark text-white pt-20 pb-8 relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              उत्तम पीक, अधिक उत्पादन आणि विश्वासार्ह शेतीसाठी आधुनिक कृषी उत्पादने. शेतकऱ्यांची प्रगती, आमचे ध्येय!
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-agri-lime hover:text-agri-dark transition-colors">
          ...
          <div>
            <h4 className="font-bold text-lg mb-6 text-agri-lime">जलद दुवे</h4>
            <ul className="space-y-3">
              <li><Link href="#home" className="text-gray-300 hover:text-white transition-colors">मुख्यपृष्ठ</Link></li>
          ...
          <div>
            <h4 className="font-bold text-lg mb-6 text-agri-lime">संपर्क</h4>
